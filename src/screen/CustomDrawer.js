  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#E5E5E5' }}>
      <DrawerContentScrollView {...props} >
        ...
        <TouchableOpacity style={{marginBottom: 30,alignItems: 'center'}} onPress={() => GallaryHandler()}>
          <Text style={{paddingVertical: 5,paddingHorizontal: 5,backgroundColor: '#7cc',color: '#000000',textAlign: 'center',width: 150,borderRadius:10,}}>Chnage profile Picture</Text>
        </TouchableOpacity>
